...
Mocha$RescriptMocha.describe("test perceptron")(undefined, undefined, undefined, (function (param) {
        Mocha$RescriptMocha.describe("test input")(undefined, undefined, undefined, (function (param) {
                ...
                var match = deconstruct(Belt_Result.getExn(Curry._1(PerceptronLayer.input, given)));
                var match$1 = match[2];
        ...
        Mocha$RescriptMocha.describe("test solve")(undefined, undefined, undefined, (function (param) {
                ...
                var match = deconstruct$1(Belt_Result.getExn(Curry._2(PerceptronLayer.solve, givenL1Vals, givenWeights)));
                var match$1 = match[1];
        ...
        Mocha$RescriptMocha.describe("test findError")(undefined, undefined, undefined, (function (param) {
                ...
                var match = deconstruct$1(Belt_Result.getExn(Curry._2(PerceptronLayer.findError, givenL2Vals, givenL2Nominals)));
                var ev2 = match[1];
                var ev1 = match[0];
        ...
        Mocha$RescriptMocha.describe("test backpropagadeError")(undefined, undefined, undefined, (function (param) {
                ...
                var givenWeights = construct(construct$1(0.76, 0.25), construct$1(0.15, -1.67), construct$1(-5.12, 3.11));
                var givenError = construct$1(MlErrorMetricFunction.ErrorMetricEuclidean.floatToErr(0.87), MlErrorMetricFunction.ErrorMetricEuclidean.floatToErr(-0.1));
                var match = deconstruct(Belt_Result.getExn(Curry._3(PerceptronLayer.backpropagadeError, givenL1Vals, givenError, givenWeights)));
                var err3 = match[2];
                var err2 = match[1];
                var err1 = match[0];
        ...
        Mocha$RescriptMocha.describe("test weightCorrection")(undefined, undefined, undefined, (function (param) {
                ...
                var givenWeights = construct(construct$1(0.76, 0.25), construct$1(0.15, -1.67), construct$1(-5.12, 3.11));
                var givenError = construct$1(MlErrorMetricFunction.ErrorMetricEuclidean.floatToErr(0.87), MlErrorMetricFunction.ErrorMetricEuclidean.floatToErr(-0.1));
                var match = deconstruct(Belt_Result.getExn(Curry._4(PerceptronLayer.weightCorrection, givenL1Vals, givenError, givenWeights, 0.1)));
