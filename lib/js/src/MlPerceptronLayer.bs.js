...
function MakePerceptronLayersCross(Layer1, Layer2, F, Err) {
  ...
  var solve = function (l1, w) {
    ...
    return Belt_Result.flatMap(Belt_Result.map(ResultExn.tryExec(function (param) {
                        return Belt_Array.mapWithIndex(Belt_Option.getExn(Belt_Array.get(weightsArr, 0)), (function (n, param) {
  ...
  var findError = function (vals, nominals) {
    return ResultExn.tryExecFlat(function (param) {
